...
export default async function Levels() {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <p className="text-center text-xl text-gray-600 dark:text-gray-300 mb-12 animate-fade-in-fast animation-delay-100">Master system design concepts through interactive challenges</p>
          ...
          >
            <Card className="group h-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-all duration-200 ease-in-out hover:border-blue-400 dark:hover:border-blue-600 hover:shadow-lg hover:shadow-blue-400/20">
              ...
              <CardFooter className="flex justify-between items-center">
                <Badge
                  variant="outline"
                  className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 border-blue-300 dark:border-blue-700 px-3 py-1 text-sm font-medium"
                >
