  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mb-14 flex justify-center">
        <div className="relative flex rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 p-2 shadow-xl dark:from-gray-800/60 dark:to-gray-900/60 dark:shadow-gray-900/30">
          {/* Background highlight for active tab */}
          <div 
            className={`absolute inset-0 m-2 h-[calc(100%-16px)] w-1/2 transform rounded-lg bg-gradient-to-r from-blue-500/90 to-purple-600/90 shadow-lg transition-all duration-300 ease-out ${
              activeTab === 'learn' ? 'translate-x-0' : 'translate-x-full'
            }`} 
          />

          <button
            onClick={() => setActiveTab('learn')}
            className={`relative z-10 flex items-center justify-center gap-2 rounded-lg px-8 py-4 text-lg font-medium transition-all duration-200 ${
              activeTab === 'learn'
                ? 'text-white'
                : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'
            }`}
          >
            <BookOpenCheck className={`h-5 w-5 flex-shrink-0 transition-all ${activeTab === 'learn' ? 'scale-110' : ''}`} />
            <span className="inline-block">Learn System Design</span>
          </button>
          
          <button
            onClick={() => setActiveTab('design')}
            className={`relative z-10 flex items-center justify-center gap-3 rounded-lg px-8 py-4 text-lg font-medium transition-all duration-200 ${
              activeTab === 'design'
                ? 'text-white'
                : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'
            }`}
          >
            <PenTool className={`h-5 w-5 flex-shrink-0 transition-all ${activeTab === 'design' ? 'scale-110' : ''}`} />
            <span className="inline-block">Design Your Systems</span>
          </button>
        </div>
      </div>
      ...
      <header className="mb-14 flex flex-col items-center justify-between md:flex-row">
        <div className="text-left md:w-1/2 md:pr-8">
          <h1 className="bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-6xl font-bold text-transparent leading-tight pb-2 md:text-7xl">
            ...
            {activeTab === 'learn' ? (
              ...
              <>
                ...
                <div className="relative inline-block">
                  ...
                  <span className="absolute -right-1 -top-1 z-10 rounded-full bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-800 shadow-sm dark:bg-amber-900/30 dark:text-amber-500">
                    Coming Soon
                  </span>
                </div>
              </>
