...
const configInfoMap: Record<string, FeatureInfo> = {
  "Free-form Text Mode": {
    ...
    description:
      "Toggle between detailed configuration and free-form text input. Free-form text allows you to describe your load balancer configuration in a more natural way.",
    learnMoreUrl: "https://docs.example.com/lb-configuration",
  },
  "Load Balancing Algorithm": {
    name: "Load Balancing Algorithm",
    description:
      "The method used to distribute traffic across backend servers. Different algorithms are suited for different workload patterns.",
    learnMoreUrl: "https://docs.example.com/lb-algorithms",
  },
  "Max Connections": {
    name: "Max Connections",
    description:
      "Maximum number of concurrent connections the load balancer can handle.",
    learnMoreUrl: "https://docs.example.com/lb-connections",
  },
  Throughput: {
    name: "Throughput",
    description:
      "Maximum number of requests per second the load balancer can process.",
    learnMoreUrl: "https://docs.example.com/lb-throughput",
  },
  Features: {
    name: "Features",
    description:
      "Additional capabilities and features that can be enabled for this load balancer. These may include SSL termination, session persistence, health checks, and more.",
    learnMoreUrl: "https://docs.example.com/load-balancer/features",
  },
  "Additional Configuration": {
    name: "Additional Configuration",
    description:
      "Additional load balancer configuration, requirements, or constraints specific to your use case.",
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              {configInfoMap["Load Balancing Algorithm"] && (
                <InfoPopup
                  feature={configInfoMap["Load Balancing Algorithm"]}
                />
              )}
            </div>
